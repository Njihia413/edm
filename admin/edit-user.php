                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" id="date" name="date_of_birth" value="<?php echo $date_of_birth ?>"><br>
                                    ...
                                    <div class="create-btn">
                                        <button type="submit" class="button" name="update_user"><span class="las la-save"></span><span>Update</span></button>
                                    </div>
                                </div>
                            </div>
                        </form>
